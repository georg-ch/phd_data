...
def main():
    ...
    OUT_FNAME = config["out_fname_for_simplified_model"]
    DUMP_FNAME = config["params_fname_for_simplified_model"]
    ...
    data, feature_col_info = engineer_features(data, simplify=True)
    find_parameters_and_predict(
        data,
        TARGET_COL_NAME,
        feature_col_info,
