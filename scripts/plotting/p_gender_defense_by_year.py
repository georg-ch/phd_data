...
from src.plotting.year_lineplot_interactive import write_year_lineplot_interactive


def main():
    params, params_global, out_path = load_plot_config("gender_by_year_def")
    ...
    marker_inst = dict(
        size=params["marker_inst_size"], symbol="circle", line=dict(width=1)
    )
    ...
    df = data[["defense_year", "faculty", "institute_name", "gender"]].copy()
