...
import re
from duration_preprocessing import add_merge_linkedin_data
...
def build_cleaned_table(df, keep_original=False):
    ...
    full_dset_list = [
        ...
        (merge_linf_duration, ("data/20250821_PromAbschluesse2000_2020_TUB.csv",)),
        (add_merge_linkedin_data, ("data/durations.csv",)),
